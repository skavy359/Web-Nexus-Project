        ...
        <div class="w-full max-w-6xl flex flex-col md:flex-row gap-10">
            ...
            <div class="formSection md:w-1/2 bg-[#0F172A] p-8 rounded-xl border-2 border-[#3E4B5E]">
                ...
                <form method="POST" class="mt-6">
                    ...
                    <button type="submit"
                        class="w-full bg-red-600 hover:bg-red-700 py-4 text-xl rounded-lg text-white font-bold hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">Login (Insecure)</button>
                </form>
                <div class="mt-4 text-center">
                    <a href="secure_page_Vulnerable_and_Outdated_Components.php" class="text-blue-400 hover:text-blue-300 text-sm hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">Try the secure version</a>
                </div>
            </div>
