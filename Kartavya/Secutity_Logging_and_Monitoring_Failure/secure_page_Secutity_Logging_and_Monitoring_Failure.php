...
<body class="bg-[#020617] text-white font-['Lexend'] selection:text-yellow-400 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_01.png'),_auto]">
    ...
    <?= $access_message ?>
            ...
            <div class="mt-4 text-center">
                    <a href="vulnerable_page_Secutity_Logging_and_Monitoring_Failure.php" class="text-blue-400 hover:text-blue-300 text-sm hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">Try the vulnerable version</a>
            </div>
        </div>
