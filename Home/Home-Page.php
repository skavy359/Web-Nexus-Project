...
<body class="bg-[#020617] font-['Lexend'] selection:text-yellow-400 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_01.png'),_auto]">
            ...
            <div class="yellowButton yellowButtonHeader hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="relative bg-yellow-300 hover:bg-yellow-600 px-3 py-2 mr-3 rounded-md border-3 border-[rgb(221,170,16)] transition-colors duration-500">
                    <div class="font-['Press_Start_2P'] drop-shadow-[2px_2px_0px_rgb(221,170,16)] text-black font-thin text-sm max-md:text-[8px]">
                        <?php if ($logged_in): ?>
                            <span onclick="event.stopPropagation(); window.location.href='/Web-Nexus-Project/Login_Pages/logout.php'">Log Out</span>
                        <?php else: ?>
                            <span onclick="event.stopPropagation(); window.location.href='/Web-Nexus-Project/Login_Pages/login_page.php'">Log In</span>
                        <?php endif; ?>
                    </div>
    ...
    <section id="home" class="h-screen flex items-center justify-center flex-col bg-[#020617] font-['Press_Start_2P'] text-center px-6">
        ...
        <div class="absolute w-full h-full flex flex-col items-center justify-center">
            ...
            <div class="mt-6 space-x-4 flex">
                <div class="hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer] flex justify-center items-center">
                    <div onclick="window.location.href='/Web-Nexus-Project/Home/Home-Page.php#vulnerabilities'" class="yellowButton yellowButtonHeader hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                        <div class="relative bg-yellow-300 hover:bg-yellow-600 px-3  py-2 mr-3 rounded-md border-3 border-[rgb(221,170,16)] transition-colors duration-500">
                            <div class="font-['Press_Start_2P'] p-1 drop-shadow-[2px_2px_0px_rgb(221,170,16)] text-black font-thin text-sm max-md:text-[8px]">
                                <a href="#vulnerabilities" class="hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">Get Started</a>
                            </div>
                            <div class="absolute w-[105%] h-[115%] bg-[rgb(221,170,16)] hover:bg-yellow-600 rounded-md  transition-colors duration-500 -z-1 top-[1%] left-0"></div>
                        </div>
                    </div>
    ...
    <section id="vulnerabilities" class="bg-[#020617] font-['Press_Start_2P'] py-20 text-white text-center">
        ...
        <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8 px-6 auto-rows-fr">
            <a href="/Web-Nexus-Project/vulnerabilities/SSRF/index.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
            ...
            <a href="/Web-Nexus-Project/Vulnerabilities/Xss/xss.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Vulnerabilities/Insecure Design/Insecure-design.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Vulnerabilities/Secutity_Logging_and_Monitoring_Failure/Secutity_Logging_and_Monitoring_Failure.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                    <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Vulnerabilities/Misconfig/misconfig.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Vulnerabilities/Broken Access Control/Broken-access-control.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Vulnerabilities/SQL Injection/Sql-injection.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Vulnerabilities/Vulnerable_and_Outdated_Components/Vulnerable_and_Outdated_Components.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="#" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-[#020617]  p-6 rounded-lg shadow-lg flex flex-col col-span-3 justify-between h-full"></div>
            </a>
            <a href="/Web-Nexus-Project/Vulnerabilities/Deserialisation/deserialisation.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
    ...
    <section class="py-20 bg-[#020617] text-white">
        ...
        <div class="mt-10 flex flex-col md:flex-row items-center justify-center px-6 gap-12 transition-transform duration-300 hover:scale-[1.03]">
            <div class="w-[220px] h-[220px] rounded-full overflow-hidden shadow-lg border-4 border-blue-500">
                <img src="/Web-Nexus-Project/Assets/Images/ronit_image.png" alt="team card" class="w-full h-full object-cover">
            </div>
        ...
        <div class="mt-10 flex flex-col md:flex-row items-center justify-center px-6 gap-12 transition-transform duration-300 hover:scale-[1.03]">
            <div class="w-[220px] h-[220px] rounded-full overflow-hidden shadow-lg border-4 border-blue-500">
                <img src="/Web-Nexus-Project/Assets/Images/Malay.jpeg" alt="team card" class="w-full h-full object-cover">
            </div>
            <div class="bg-gray-800 p-6 rounded-lg shadow-lg w-full max-w-lg h-[220px] flex flex-col justify-between">
                <p class="text-md md:text-lg italic text-gray-300 font-['Lexend']">
    ...
    <script src="/Web-Nexus-Project/Assets/Animations/HomePageAnimation/homepage_animation.js"></script>
