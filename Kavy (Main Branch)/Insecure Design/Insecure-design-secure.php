...
<body class="bg-[#020617] text-white font-['Lexend'] cursor-[url('/Assets/Images/cursor_01.png'),_auto]">
    ...
    <nav class="fixed z-[999] top-0 left-0 h-[10vh] w-screen flex items-center justify-between p-4 bg-[#020617] border-b-2 border-[#3E4B5E] max-md:p-0">
        ...
        <div class="space-x-10 max-md:space-x-4 flex flex-1 justify-center items-center">
            <a href="/Kavy (Main Branch)/Home/Home-Page.html#vulnerabilities" class="headerStuff transition-transform duration-300 ease-in-out hover:scale-110 hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer] text-center font-semibold text-white hover:text-gray-300 max-md:text-xs">Vulnerabilities</a>
            <a href="/Kavy (Main Branch)/Home/Home-Page.html" class="headerStuff transition-transform duration-300 ease-in-out hover:scale-110 hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer] text-center font-semibold text-white hover:text-gray-300 max-md:text-xs max-md:hidden">Home</a>
            <a href="/Karan/About Us/contact_us.html" class="headerStuff transition-transform duration-300 ease-in-out hover:scale-110 hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer] text-center font-semibold text-white hover:text-gray-300 max-md:text-xs max-md:hidden">Contact Us</a>
        </div>
        ...
        <div class="w-full max-w-7xl flex flex-col md:flex-row gap-8">
            ...
            <div class="md:w-1/2 bg-[#0F172A] p-6 rounded-lg border-2 border-[#3E4B5E] shadow-lg">
                ...
                <div class="mt-4 text-center">
                    <a href="Insecure-design-vulnerable.php" class="text-blue-400 hover:text-blue-300 text-sm hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">Try the Insecure version</a>
                </div>
            </div>
