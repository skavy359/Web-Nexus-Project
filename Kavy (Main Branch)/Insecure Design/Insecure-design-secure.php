            ...
            <div class="md:w-1/2 bg-[#0F172A] p-6 rounded-lg border-2 border-[#3E4B5E] shadow-lg">
                ...
                <div>
                    ...
                    <form method="POST" class="space-y-4">
                        ...
                        <button type="submit" name="request_reset" class="relative bg-green-500 hover:bg-green-600 w-full px-4 py-3 rounded-md border-2 border-[rgb(34,197,94)] transition-colors duration-500 group hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">
                ...
                <div class="mt-6">
                    ...
                    <form method="POST" class="space-y-4">
                        ...
                        <button type="submit" name="confirm_reset" class="relative bg-green-500 hover:bg-green-600 w-full px-4 py-3 rounded-md border-2 border-[rgb(34,197,94)] transition-colors duration-500 group hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">
                ...
                <div>
                    ...
                    <div class="border border-green-500 rounded-md p-4 mb-6">
                        ...
                        <form method="GET" class="space-y-4">
                            ...
                            <button type="submit" class="relative bg-green-500 hover:bg-green-600 w-full px-4 py-2 rounded-md border-2 border-[rgb(34,197,94)] transition-colors duration-500 group hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">
                    ...
                    <!-- Logout Button -->
                    <div class="mt-6">
                        <a href="?logout=1" class="relative bg-red-500 hover:bg-red-600 w-full px-4 py-3 rounded-md border-2 border-[rgb(239,68,68)] transition-colors duration-500 group flex justify-center hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">
...
if (isset($_GET['view_account']) && !empty($_SESSION['username'])) {
    ...
    <!-- FOOTER -->
    <footer class="py-8 bg-[#020617] border-t-2 border-[#3E4B5E]">
        <div class="container mx-auto px-4">
            <div class="flex flex-col md:flex-row justify-between items-center">
                <div class="mb-6 md:mb-0">
                    <div class="flex items-center space-x-3">
                        <img src="/Assets/Images/logo.svg" alt="logo" class="w-12" />
                        <span class="text-xl text-white font-bold font-['Press_Start_2P'] font-black drop-shadow-[5px_5px_0px_black] drop-shadow-[-5px_-5px_0px_black]">Web-Nexus</span>
                    </div>
                    <p class="text-gray-400 mt-2">Learn about web security vulnerabilities and best practices.</p>
                </div>
                <div class="flex flex-col md:flex-row space-y-4 md:space-y-0 md:space-x-8">
                    <div>
                        <h3 class="text-lg font-bold text-white mb-2">Resources</h3>
                        <ul class="text-gray-400 space-y-2">
                            <li><a href="#" class="hover:text-gray-300 hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">OWASP Top 10</a></li>
                            <li><a href="#" class="hover:text-gray-300 hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">Security Guidelines</a></li>
                            <li><a href="#" class="hover:text-gray-300 hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">Best Practices</a></li>
                        </ul>
                    </div>
                    <div>
                        <h3 class="text-lg font-bold text-white mb-2">Connect</h3>
                        <ul class="text-gray-400 space-y-2">
                            <li><a href="#" class="hover:text-gray-300 hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">GitHub</a></li>
                            <li><a href="#" class="hover:text-gray-300 hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">Twitter</a></li>
                            <li><a href="#" class="hover:text-gray-300 hover:cursor-[url('/Assets/Images/cursor_02.png'),_pointer]">Discord</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            <div class="mt-8 text-center text-gray-500 text-sm">
                <p>© 2025 Web-Nexus. All rights reserved. Created for educational purposes.</p>
            </div>
        </div>
    </footer>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            if (menuBtn) {
                menuBtn.addEventListener('click', function() {
                    // Mobile menu toggle code would go here
                    alert('Mobile menu functionality would be implemented here!');
                });
            }
            
            // Apply auto-timeout for session (15 minutes)
            setTimeout(function() {
