...
if(isAdmin) {
    ...
    const text3 = "You have manipulated the isAdmin property and "
    textElement3.textContent = "";
    ...
    const text4 = "gained access to the ";
    textElement4.textContent = "";
