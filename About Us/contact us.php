...
<html class="scroll-smooth" lang="en">
  ...
  <body
    class="w-full min-h-screen bg-[url('/Web-Nexus-Project/Assets/Images/webNexusBackground.svg')] bg-cover bg-center bg-no-repeat  cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_01.png'),_auto]"
            ...
            <form id="contactForm" action="process_contact.php" method="POST" class="space-y-6">
              <div>
                ...
                <input 
                  ...
                  name="email" 
                  required 
                  class="w-full p-3 bg-[#1E293B] border border-[#3E4B5E] rounded-md text-white focus:outline-none focus:ring-2 focus:ring-yellow-300 hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]"
              ...
              <div class="flex justify-center">
                <button 
                  type="submit" 
                  class="relative bg-yellow-300 hover:bg-yellow-600 px-6 py-3 rounded-md border-3 border-[rgb(221,170,16)] transition-colors duration-500 hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]"
                >
  ...
  <script src="/Web-Nexus-Project/Assets/Animations/ContactUsAnimation/contact_us_animation.js"></script>
