            ...
            <div onclick="window.location.href='Broken-access-control.php'" class="yellowButton yellowButtonHeader hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="relative bg-yellow-300 hover:bg-yellow-600 px-3 py-2 mr-3 rounded-md border-3 border-[rgb(221,170,16)] transition-colors duration-500">
                    <div class="font-['Press_Start_2P'] drop-shadow-[2px_2px_0px_rgb(221,170,16)] text-black font-thin text-sm max-md:text-[8px]">
                        <a href="/Web-Nexus-Project/Kavy/Broken Access Control/Broken-access-control.php">Back to Vulnerability</a>
                    </div>
            ...
            <div class="formSection md:w-1/2 bg-[#0F172A] p-6 rounded-lg border-2 border-[#3E4B5E] shadow-lg">
                ...
                <div class="mb-8">
                    ...
                    <form method="POST" class="space-y-4">
                        ...
                        <button type="submit" name="login" class="relative bg-green-500 hover:bg-green-600 w-full px-4 py-3 rounded-md border-2 border-[rgb(34,197,94)] transition-colors duration-500 group hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                ...
                <div>
                    ...
                    <div class="border border-green-500 rounded-md p-4 mb-6">
                        ...
                        <form method="POST" class="space-y-4">
                            ...
                            <button type="submit" formmethod="GET" class="relative bg-green-500 hover:bg-green-600 w-full px-4 py-2 rounded-md border-2 border-[rgb(34,197,94)] transition-colors duration-500 group hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                ...
                <div class="mt-4 text-center">
                    <a href="bac-vulnerable.php" class="text-blue-400 hover:text-blue-300 text-sm hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">Try the vulnerable version</a>
                </div>
            </div>
