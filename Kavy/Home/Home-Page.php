...
<body class="bg-[#020617] font-['Lexend'] selection:text-yellow-400 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_01.png'),_auto]">
    ...
    <section id="home" class="h-screen flex items-center justify-center flex-col bg-[#020617] font-['Press_Start_2P'] text-center px-6">
        ...
        <div class="absolute w-full h-full flex flex-col items-center justify-center">
            ...
            <div class="mt-6 space-x-4 flex">
                <div class="hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer] flex justify-center items-center">
                    <div onclick="window.location.href='/Web-Nexus-Project/Kavy/Home/Home-Page.php#vulnerabilities'" class="yellowButton yellowButtonHeader hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                        <div class="relative bg-yellow-300 hover:bg-yellow-600 px-3  py-2 mr-3 rounded-md border-3 border-[rgb(221,170,16)] transition-colors duration-500">
    ...
    <section id="vulnerabilities" class="bg-[#020617] font-['Press_Start_2P'] py-20 text-white text-center">
        ...
        <div class="mt-10 grid grid-cols-1 md:grid-cols-3 gap-8 px-6 auto-rows-fr">
            ...
            <a href="/Web-Nexus-Project/Kavy/Insecure Design/Insecure-design.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Malay/Misconfig/misconfig.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Kavy/Broken Access Control/Broken-access-control.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Kavy/SQL Injection/Sql-injection.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Kartavya/Vulnerable_and_Outdated_Components/Vulnerable_and_Outdated_Components.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
                <div class="bg-gray-800 p-6 rounded-lg shadow-lg flex flex-col justify-between h-full">
            ...
            <a href="/Web-Nexus-Project/Malay/Deserialisation/deserialisation.php" class="vulnerabilityTile block transform transition-transform duration-300 hover:scale-105 cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">
    ...
    <script src="/Web-Nexus-Project/Malay/Animations/HomePageAnimation/homepage_animation.js"></script>
