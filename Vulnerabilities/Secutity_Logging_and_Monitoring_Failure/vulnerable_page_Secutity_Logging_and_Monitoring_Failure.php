...
<body class="bg-[#020617] text-white font-['Lexend'] selection:text-yellow-400 cursor-[url('../../Assets/Images/cursor_01.png'),_auto]">
    ...
    <nav class="fixed z-[999] top-0 left-0 h-[10vh] w-screen flex items-center justify-between p-4 bg-[#020617] border-b-2 border-[#3E4B5E] max-md:p-0">
        ...
        <div class="hover:cursor-[url('../../Assets/Images/cursor_02.png'),_pointer] flex justify-center items-center">
            <div onclick="window.location.href='Secutity_Logging_and_Monitoring_Failure.php'" class="yellowButton yellowButtonHeader hover:cursor-[url('../../Assets/Images/cursor_02.png'),_pointer]">
                <div class="relative bg-yellow-300 hover:bg-yellow-600 px-3 py-2 mr-3 rounded-md border-3 border-[rgb(221,170,16)] transition-colors duration-500">
                    <div class="font-['Press_Start_2P'] drop-shadow-[2px_2px_0px_rgb(221,170,16)] text-black font-thin text-sm max-md:text-[8px]">
                        <a href="../../Kartavya\Secutity_Logging_and_Monitoring_Failure\Secutity_Logging_and_Monitoring_Failure.php">Back to Vulnerability</a>
                    </div>
    ...
    <div class="formSection md:w-1/2 bg-[#0F172A] p-8 rounded-xl border-2 border-[#3E4B5E]">
        ...
        <form method="POST" class="mt-6">
            <div class="mb-6">
                ...
                <input type="text" name="username" id="username"
                    ...
                    class="w-full p-5 bg-[#1E293B] border border-[#3E4B5E] rounded-xl text-white" placeholder="Enter username">
        ...
        <div class="mt-4 text-center">
                <a href="secure_page_Secutity_Logging_and_Monitoring_Failure.php" class="text-blue-400 hover:text-blue-300 text-sm hover:cursor-[url('../../Assets/Images/cursor_02.png'),_pointer]">Try the secure version</a>
        </div>
    </div>
        ...
        <div class="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8 text-center md:text-left">
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2">
                    <li><a href="../../About Us/contact_us.php" class=" hover:cursor-[url('../../Assets/Images/cursor_02.png'),_pointer] text-gray-300 hover:text-white">About Us</a></li>
            ...
            <div>
                ...
                <ul class="mt-4 space-y-2">
                    ...
                    <li><a href="../../About Us/contact_us.php" class=" hover:cursor-[url('../../Assets/Images/cursor_02.png'),_pointer] text-gray-300 hover:text-white">Contact</a></li>
