            ...
            <div class="formSection md:w-1/2 bg-[#0F172A] p-6 rounded-lg border-2 border-[#3E4B5E] shadow-lg">
                ...
                <form method="POST" class="mt-4">
                    ...
                    <div class="mt-4 text-center">
                        <a href="Sql-injection-Vulnerable.php" class="text-blue-400 hover:text-blue-300 text-sm hover:cursor-[url('/Web-Nexus-Project/Assets/Images/cursor_02.png'),_pointer]">See the vulnerable version</a>
                    </div>
                </form>
